      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Ionicons name="repeat-outline" size={64} color={colors.gold} />
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.typeSelector}>
                <TouchableOpacity 
                  style={[styles.typeOption, formData.type === 'income' && styles.typeOptionIncomeSelected]} 
                  onPress={() => setFormData({ ...formData, type: 'income', category_id: incomeCategories[0]?.id || '' })}
                >
                  <Text style={[styles.typeOptionText, formData.type === 'income' && styles.typeOptionTextSelected]}>Receita</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                  style={[styles.typeOption, formData.type === 'expense' && styles.typeOptionExpenseSelected]} 
                  onPress={() => setFormData({ ...formData, type: 'expense', category_id: expenseCategories[0]?.id || '' })}
                >
              ...
              <View style={styles.frequencySelector}>
                {['monthly', 'weekly', 'yearly'].map((freq) => (
                  <TouchableOpacity 
                    key={freq} 
                    style={[styles.frequencyOption, formData.frequency === freq && styles.frequencyOptionSelected]} 
              ...
              <TextInput 
                ...
                onChangeText={(t) => setFormData({ ...formData, day_of_month: t })} 
                ...
                <>
                  ...
                  <View style={styles.paymentMethods}>
                    {[{ id: 'cash', label: 'Dinheiro' }, { id: 'debit', label: 'Débito' }, { id: 'credit', label: 'Crédito' }].map((m) => (
                      <TouchableOpacity 
                        key={m.id} 
                        style={[styles.paymentMethod, formData.payment_method === m.id && styles.paymentMethodSelected]} 
                        onPress={() => setFormData({ ...formData, payment_method: m.id })}
                      >
